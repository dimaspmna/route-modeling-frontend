    ...
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                ...
                const res = await API.get(`/get-user-requests?email=${email}`);
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                        <div className="flex-1">
                            ...
                            >
                                ...
                                <option value="process to fleet team">Dalam Proses</option>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Request</th>
                                    <th scope="col" className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Fleet</th>
                                    <th scope="col" className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Lokasi Destinasi</th>
                                    <th scope="col" className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Note</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr key={`${item.ship_request_id}-${index}`} className="hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-4 whitespace-nowrap">
                                            <div className="flex flex-col">
                                                ...
                                                {/* {item.status_request?.toLowerCase() === "approved" && (
                                                    <button
                                        ...
                                        <td className="py-4 px-4 whitespace-nowrap">
                                            <div className="inline-flex items-center">
                                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusClass(item.fleet_status)}`}>
                                                    {getStatusIcon(item.fleet_status)}
                                                    <span className="ml-1.5">{item.fleet_status || "Unknown"}</span>
                                                </span>
                                            </div>
                                        </td>
