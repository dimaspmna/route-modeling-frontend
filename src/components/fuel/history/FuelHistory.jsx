    ...
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                ...
                const res = await API.get(`/fuel/history`);
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fleet Status</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredHistory.map((item, index) => (
                                    <tr key={`${item.ship_request_id}-${index}`} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="py-4 px-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{item.admin_note}</div>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
