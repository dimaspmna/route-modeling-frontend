...
import EditFuelEntries from "./EditFuelEntries";
...
const FuelEntries = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await API.get("/get-fuel-request");
                setData(res.data || []);
            } catch (err) {
                console.error("Gagal ambil data fuel:", err);
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleQuickUpdate = async (item, newStatus) => {
        try {
            await API.put(`/fuel-request/${item.ship_request_id}`, {
                ...item,
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Memuat data fuel request...</p>
                </div>
            </div>
        );
    }
                ...
                <table className="w-full">
                    <thead className="bg-blue-100">
                        <tr className="border-b border-gray-200">
                            ...
                            <th className="py-4 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jenis Material</th>
            ...
            <div className="mx-auto">
                ...
                <div className="mb-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Admin Fuel Management</h1>
                            <p className="text-gray-600 mt-1">Kelola semua permintaan fuel dari user</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Table */}
                {renderTable(paginatedData, "Fuel Requests")}
