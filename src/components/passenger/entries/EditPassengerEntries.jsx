...
import SuccessAlertPassenger from "../components/SuccessAlertPassenger";

const EditPassengerEntries = ({ data, onSave, onCancel }) => {
    ...
    const handleSave = async () => {
        ...
        setLoading(true);
        try {
            await API.put(`/passenger-request/${data.ship_request_id}`, {
                kuantitas: volume,
            ...
            // tunda close modal 3 detik (sesuai auto-close SuccessAlertPassenger)
            setTimeout(() => {
                onSave({
                    ...data,
                    kuantitas: volume,
    ...
    return (
        <>
                ...
                <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-semibold text-gray-900">Edit Fresh Water Request</h2>
                            <button
                                onClick={onCancel}
                    ...
                    <div className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Jenis Fresh Water</label>
                                <div className="w-full border border-gray-300 px-4 py-3 rounded-lg bg-gray-200 text-gray-600">
                                    {data?.jenis_material || "-"}
                                </div>
                            </div>
            ...
            {showSuccess && (
                <SuccessAlertPassenger
                    message="Data fresh water request berhasil diperbarui!"
...
export default EditPassengerEntries;