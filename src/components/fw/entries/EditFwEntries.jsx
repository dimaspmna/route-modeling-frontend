...
import SuccessAlertFw from "../components/SuccessAlertFw";

const EditFwEntries = ({ data, onSave, onCancel }) => {
    ...
    const handleSave = async () => {
        ...
        setLoading(true);
        try {
            await API.put(`/fw-request/${data.ship_request_id}`, {
                kuantitas: volume,
            ...
            // tunda close modal 3 detik (sesuai auto-close SuccessAlertFw)
            setTimeout(() => {
                onSave({
                    ...data,
                    kuantitas: volume,
